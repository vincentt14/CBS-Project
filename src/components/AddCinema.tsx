        ...
        <div className="flex flex-col items-center justify-center text-center">
          <div className="p-5">
            ...
            <div className="flex items-center justify-between my-4">
              ...
              <input required type="number" className="ml-8 p-2 border-borderColor border rounded-md" onChange={(e) => setTotalSeats(+e.target.value)} />
            </div>
            <div className="flex items-center justify-between">
              ...
              <CustomButton btnType="submit" title="Add Cinema" containerStyles="ml-4 border-borderColor bg-secondary hover:border-primary" textStyles="text-white" />
            </div>
          </div>
        </div>
        <div className="flex flex-col items-center justify-center text-center">
