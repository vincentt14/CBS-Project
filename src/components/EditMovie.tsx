        ...
        <div className="flex flex-col items-center justify-center text-center">
          <div className="p-5">
            ...
            <div className="flex items-center justify-between my-4">
              ...
              <input required className="ml-8 p-2 border-borderColor border rounded-md bg-bgColor" value={duration} onChange={(e) => setDuration(e.target.value)} />
            </div>
            <div className="flex items-center justify-between">
              ...
              <CustomButton btnType="submit" title="Edit Movie" containerStyles="ml-4 border-borderColor bg-black hover:border-primary" textStyles="text-white" />
            </div>
          </div>
        </div>
        <div className="flex flex-col items-center justify-center text-center">
          <div className="p-5">
            ...
            <div className="flex items-center justify-between my-4">
              ...
              <textarea style={{ "overflow" : "hidden" }} required className="ml-8 p-2 border-borderColor border rounded-md w-[198px] h-44 bg-bgColor" value={synopsis} onChange={(e) => setSynopsis(e.target.value)} />
            </div>
          </div>
        </div>
      </form>
